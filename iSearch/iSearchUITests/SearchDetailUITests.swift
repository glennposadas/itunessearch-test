...
class SearchDetailUITests: BaseUITestCase {
    ...
    func testAllViewsVisibility() {
        ...
        XCTAssert(app.staticTexts["In STAR WARS: THE RISE OF SKYWALKER, the riveting conclusion of the landmark Skywalker saga, new legends will be born—and the final battle for freedom is yet to come. WARNING: SOME FLASHING-LIGHTS SCENES IN THIS FILM MAY AFFECT PHOTOSENSITIVE VIEWERS"].exists, "About the movie label value must exist.")
    }
}
